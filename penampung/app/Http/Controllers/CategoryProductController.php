...
class CategoryProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // $iconFolder = base_path('../assets/icons'); // Lokasi folder ikon
        // $icons = scandir($iconFolder); // Ambil semua file dalam folder
        ...
        $filename = '';
        if ($iconSearch) {
        //     $from = $iconFolder . '/' . $iconSearch; // Lokasi file sumber
        //     $to = base_path('../assets/img/product/'. $request->nm_category . '-' .$iconSearch ); // Lokasi file tujuan
        //    copy($from, $to);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $this->logAuditTrail('delete', $category, $category, null);
