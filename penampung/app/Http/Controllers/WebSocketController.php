    ...
    public function onOpen(ConnectionInterface $conn)
    {
        ...
        if (isset($params)) {
            ...
            if ($params['type'] == 'customer') {
                ...
                if ($params['conversation_id']) {               // Attach the connection to SplObjectStorage
                    $this->clients->attach($conn, [
                        'conversation_id' => $params['conversation_id'],
                        'connection' => $conn,
                        'user_id' => $admin,
    ...
    public function onMessage(ConnectionInterface $from, $msg)
    {
        ...
        if (isset($params)) {
            ...
            if ($params['type'] == 'customer') {
                ...
                //     //     if ($client['type'] === 'admin' && $client['w ilayahId'] === $wilayah) {
                ...
                if (isset($data['conversation_id'])) {
                    ...
                    if (isset($data['params'])) {
                        ...
                        foreach ($this->clients as $clientConn) {
                            ...
                            if ($clientInfo['type'] === 'admin' && $clientInfo['cabangId'] == $cabang && $clientInfo['user_id'] != $params['id_user']) {
                                $clientInfo['connection']->send(json_encode([
                                    'params' => $data['params'],
                                ...
                                $recipientFound = true;
                                echo "terkirim ke admin cabang";
                            }
                        }
                        echo 'masuk ke params';
                        return false;
                    }
                    if ($chatId) {
                        ...
                        foreach ($this->clients as $clientConn) {
                            ...
                            if ($clientInfo['type'] === 'admin' && $clientInfo['cabangId'] == $cabang && $clientInfo['user_id'] != $params['id_user']) {
                                ...
                                echo "terkirim ke admin cabang lain  ";
                            }
                        }
