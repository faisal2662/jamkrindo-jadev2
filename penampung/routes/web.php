...
use App\Http\Controllers\JamnationController;
...
Route::get('/jamkrindo/get-dwh', [ReportDWHController::class, 'getDwh']);
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'users-management', 'as' => 'user-manager.'], function () {
        ...
        Route::post('/sync-data', [UserManagementController::class, 'dataApi'])->name('user-sync');
    ...
    Route::group(['prefix' => 'news-management', 'as' => 'news-manager.'], function () {
        ...
        Route::get('/movingData', [NewManagementController::class,'movingData'])->name('news.movingData');
    });
    ...
    Route::group(['prefix' => 'report'], function () {
        ...
        Route::get('/dwh', [ReportDWHController::class, 'dwh'])->name('report.dwh');
        Route::get('/dwh-pdf', [ReportDWHController::class, 'dwhPdf'])->name('report.dwh.pdf');
        Route::get('/dwh-raw-pdf', [ReportDWHController::class, 'dwhRawPdf'])->name('report.dwh.raw.pdf');
        Route::get('/dwh-raw-excel', [ReportDWHController::class, 'dwhRawExcel'])->name('report.dwh.raw.excel');
        Route::get('/dwh-excel', [ReportDWHController::class, 'dwhExcel'])->name('report.dwh.excel');
        Route::get('/dwh-preview', [ReportDWHController::class, 'dwhPreview'])->name('report.dwh.preview');
        Route::get('/dwh-datables', [ReportDWHController::class, 'dwhDataTables'])->name('report.dwh.getData');
        // Route::get('/{id}/detail', [RoleController::class, 'detail'])->name('jade.role.detail');
        // Route::post('/save', [RoleController::class, 'save'])->name('jade.role.save');

        // report DWH
        // Route::group(['prefix' => 'dwh'], function () {
        //     Route::get('/spd', [ReportDWHController::class, 'dwhSpd'])->name('report.dwh.spd');
        //     Route::get('/spd-pdf', [ReportDWHController::class, 'spdPdf'])->name('dwh.spd.pdf');
        //     Route::get('/spd-excel', [ReportDWHController::class, 'spdExcel'])->name('dwh.spd.excel');
        //     Route::post('/spd/data', [ReportDWHController::class, 'spd'])->name('dwh.spd.getData');
    ...
    Route::group(['prefix' => 'jamnation'], function(){
        Route::get('/kanca-all', [JamnationController::class, 'kanca'])->name('jamnation.kanca');
