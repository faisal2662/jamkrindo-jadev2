                            ...
                            <table class="table datatable table-hover table-striped display expandable-table" id="customers-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-size: 11px">No SP</th>
                                        <th style="font-size: 11px">Tanggal SP</th>
                                        <th style="font-size: 11px">Nasabah</th>
                                        <th style="font-size: 11px">Kantor Wilayah</th>
                                        <th style="font-size: 11px">Wilayah Kerja</th>
                                        <th style="font-size: 11px">Penerima Jaminan</th>
                                        <th style="font-size: 11px">lob</th>
                                        <th style="font-size: 11px">Produk</th>
                                        <th style="font-size: 11px">NPWP</th>
                                        {{-- <th>Penerbitan</th> --}}
                                        {{-- <th>Action</th> --}}
                                    </tr>
                                </thead>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnPdf').on('click', function(e) {
            e.preventDefault();
            window.open('{{ route("report.dwh.pdf") }}' + '?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val(), '_blank');
        });
        $('#btnExcel').on('click', function(e) {
            e.preventDefault();
            window.open('{{ route("report.dwh.excel") }}' + '?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val(), '_blank');
        });
