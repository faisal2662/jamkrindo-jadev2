...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#btnPdf').on('click', function(e) {
            ...
            var periode = document.getElementById('periode').value;
            var lob = document.getElementById('lob').value;
            window.open('{{ route("dwh.volume.penjaminan.pdf") }}' + '?wilayah=' + $('#id_wilayah').val() + '&bulan=' + $('#bulan').val() + '&tahun=' + $('#tahun').val() + '&periode=' + $('#periode').val() + '&lob=' + $('#lob').val(), '_blank');
        });
        $('#btnExcel').on('click', function(e) {
            ...
            var periode = document.getElementById('periode').value;
            var lob = document.getElementById('lob').value;
            window.open('{{ route("dwh.volume.penjaminan.excel") }}' + '?wilayah=' + $('#id_wilayah').val() + '&bulan=' + $('#bulan').val() + '&tahun=' + $('#tahun').val() + '&periode=' + $('#periode').val() + '&lob=' + $('#lob').val(), '_blank');
        });
    });
</script>
@stop
