                            ...
                            @foreach ($dwh as $kantorWilayah => $wilayahData)
                                ...
                                @foreach ($wilayahData as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $item->total_kbg }}</td>
                                        <td class="text-center">{{ $item->total_suretyship }}</td>
                                        <td class="text-center">{{ $item->total_kbg + $item->total_suretyship }}</td>
