...
<script>
    ...
    $('#btnFilter').on('click', function(e) {
        ...
        var table = new DataTable('#customers-table', {
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('dwh.serviceijp.getData') }}",
                type: 'POST',
    ...
    $('#btnPdf').on('click', function(e) {
        ...
        window.open('{{ route("dwh.serviceijp.excel") }}' + '?wilayah=' + $('#id_wilayah').val() + '&periodeawal=' + $('#periodeawal').val() + '&periodeakhir=' + $('#periodeakhir').val()+ '&unit_kerja=' + $('#unit_kerja').val()+ '&jenis_penerima_jaminan=' + $('#jenis_penerima_jaminan').val()+ '&penerima_jaminan=' + $('#penerima_jaminan').val()+ '&id_produk=' + $('#id_produk').val()+ '&id_pola_penjaminan=' + $('#id_pola_penjaminan').val()+ '&id_jenis_kur=' + $('#id_jenis_kur').val()+ '&id_jenis_penjaminan=' + $('#id_jenis_penjaminan').val() + '&lob=' + $('#lob').val(), '_blank');
        // table.ajax.url("{{ route('report.customer.pdf') }}" + '?startDate=' + $('#startDate').val() + '&endDate=' + $('#endDate').val()).load();
        $('#btnPdf').removeAttr('disabled');
        $('#btnExcel').removeAttr('disabled');
    });
