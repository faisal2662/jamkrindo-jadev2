                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control form-control-sm" id="periodeawal"
                                                    name="periodeawal" value="{{ date('d-m-Y') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="periode" class="form-label">Periode Akhir</label>
                                                <input type="date" class="form-control form-control-sm" id="periodeakhir"
                                                    name="periodeakhir" value="{{ date('d-m-Y') }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="startDate" class="form-label">Wilayah</label>
                                                <select name="id_wilayah" id="id_wilayah"
                                                    class="form-control form-control-sm">
                                                    <option value="">-- Pilih Wilayah --</option>
                                                    {{-- @foreach ($wilayah as $wlyh)
                                                        <option value="{{ $wlyh['id_kanwil'] }}">
                                                            {{ $wlyh['wilayah_kerja'] }}</option>
                                                    @endforeach --}}
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="unit_kerja" id="unit_kerja"
                                                    ...
                                                    {{-- @foreach ($unitkerja as $uker)
                                                        <option value="{{ $uker['id_kanwil'] }}">
                                                            {{ $uker['kantor_wilayah'] }}</option>
                                                    @endforeach --}}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="jenis_penerima_jaminan" class="form-label">Jenis Penerima
                                                    Jaminan</label>
                                                <select name="jenis_penerima_jaminan" id="jenis_penerima_jaminan"
                                                    class="form-control form-control-sm">
                                                    <option value="">-- Pilih Jenis Penerima Jaminan --</option>
                                                    {{-- @foreach ($getJnsPenerimaJaminan as $jpj)
                                                        <option value="{{ $jpj['id_jenis_penerima_jaminan'] }}">
                                                            {{ $jpj['jenis_penerima_jaminan'] }}</option>
                                                    @endforeach --}}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="penerima_jaminan" id="penerima_jaminan"
                                                    class="form-control form-control-sm">
                                                    <option value="">-- Pilih Penerima Jaminan --</option>
                                                    {{-- @foreach ($getPenerimaJaminan as $pj)
                                                        <option value="{{ $pj['id_penerima_jaminan'] }}">
                                                            {{ $pj['penerima_jaminan'] }}</option>
                                                    @endforeach --}}
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="id_pola_penjaminan" id="id_pola_penjaminan"
                                                    class="form-control form-control-sm">
                                                    <option value="">-- Pilih Penjaminan --</option>
                                                    {{-- @foreach ($polaPenjaminan as $pp)
                                                        <option value="{{ $pp['id_pola_penjaminan'] }}">
                                                            {{ $pp['pola_penjaminan'] }}</option>
                                                    @endforeach --}}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="id_jenis_kur" id="id_jenis_kur"
                                                    class="form-control form-control-sm">
                                                    <option value="">-- Pilih Jenis Kur --</option>
                                                    {{-- @foreach ($jenisKur as $jk)
                                                        <option value="{{ $jk['id_jenis_kur'] }}">{{ $jk['jenis_kur'] }}
                                                        </option>
                                                    @endforeach --}}
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="id_jenis_penjaminan" class="form-label">Jenis
                                                    Penjaminan</label>
                                                <select name="id_jenis_penjaminan" id="id_jenis_penjaminan"
                                                    class="form-control form-control-sm">
                                                    <option value="">-- Pilih Jenis Penjaminan --</option>
                                                    {{-- @foreach ($jenisPenjaminan as $jp)
                                                        <option value="{{ $jp['id_jenis_penjaminan'] }}">
                                                            {{ $jp['jenis_penjaminan'] }}</option>
                                                    @endforeach --}}
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <table class="table table-hover table-striped " id="customers-table">
                                    ...
                                    <tbody>
                                        @php
                                            $no = 1;
                                        @endphp
                                        @foreach ($data as $wilayah => $cabangs)
                                            @php $rowspan = count($cabangs); @endphp
                                            @foreach ($cabangs as $index => $cabang)
                                                @foreach ($cabang as $namaCabang => $jumlah)
                                                    @if ($namaCabang != 'total')
                                                        <tr>
                                                            {{-- Tampilkan wilayah hanya di baris pertama --}}
                                                            @if ($loop->parent->first && $loop->first)
                                                            <td rowspan="{{ $rowspan }}">{{$no++ }}</td>
                                                                <td rowspan="{{ $rowspan }}">{{ $wilayah }}</td>
                                                            @endif
                                                            <td>{{ $namaCabang }}</td>
                                                            <td>{{ $jumlah }}</td>
                                                            <td> % {{ $jumlah }}</td>
...
@section('script')
    <script>
        ...
        //                 penerima_jaminan: penerima_jaminan,
        //                 id_produk: id_produk,
        //                 id_pola_penjaminan: id_pola_penjaminan,
        //                 id_jenis_kur: id_jenis_kur,
        //                 id_jenis_penjaminan: id_jenis_penjaminan,
        //                 lob: lob
        //             }
        //         },
        //         columns: [{
        ...
        $(document).ready(function() {
            ...
            $('#btnPdf').on('click', function(e) {
                e.preventDefault();
                window.open('{{ route('report.customer.pdf') }}' + '?startDate=' + $('#startDate').val() +
                    '&endDate=' + $('#endDate').val(), '_blank');
            });
            $('#btnExcel').on('click', function(e) {
                e.preventDefault();
                window.open('{{ route('report.customer.excel') }}' + '?startDate=' + $('#startDate')
                    .val() + '&endDate=' + $('#endDate').val(), '_blank');
            });
        });
    </script>
@stop
