    ...
    <section class="profile">
        <div class="row bg-white p-4">
            ...
            <div class="tab-pane fade show active profile-overview">
                ...
                <div class="row mb-2">
                    <div class="row">
                        <div class="col"><span class="label">Created By : </span> {{$region->created_by}} </div>
                        <div class="col"><span class="label">Updated By : </span> {{$region->updated_by}} </div>
                        <div class="col"><span class="label">Deleted By : </span> {{$region->deleted_by}} </div>
                    </div>
                    <div class="row">
                        <div class="col"><span class="label">Created Date : </span> {{ Carbon\Carbon::parse($region->created_date)->translatedFormat('l, d F Y') }} </div>
                        <div class="col"><span class="label">Updated By : </span> {{ Carbon\Carbon::parse($region->updated_date)->translatedFormat('l, d F Y') }} </div>
                        <div class="col"><span class="label">Deleted By : </span> {{ Carbon\Carbon::parse($region->deleted_date)->translatedFormat('l, d F Y') }} </div>
