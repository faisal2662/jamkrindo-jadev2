    ...
    <section class="profile">
        <div class="row bg-white p-4">
            ...
            <div class="tab-pane fade show active profile-overview">
                ...
                <form action="{{ route('region-manager.update', $region->id_kanwil) }}" method="post">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Nama Wilayah <span class="text-danger">*</span></div>
                        <div class="col-lg-9 col-md-8"><input type="text" name="nm_wilayah" id="nama_wilayah"
                                class="form-control" required value="{{ $region->nm_wilayah }}"></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Kode Wilayah</div>
                        <div class="col-lg-9 col-md-8"><input type="text" name="kd_wilayah" id="kode_wilayah"
                                class="form-control" value="{{ $region->kd_wilayah }}"></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Email Wilayah</div>
                        <div class="col-lg-9 col-md-8"><input type="email" name="email" id="email"
                                class="form-control" value="{{ $region->email }}"></div>
                    </div>

                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Deskripsi</div>
                        <div class="col-lg-9 col-md-8">
                            <textarea type="text" name="desc_wilayah" cols="10" id="deskripsi" class="form-control">{{ $region->desc_wilayah }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Provinsi <span class="text-danger">*</span></div>
                        <div class="col-lg-9 col-md-8"><select name="kd_provinsi" id="provinsi" class="form-control"
                                required>
                                <option value="" disabled>Pilih Provinsi</option>
                                @foreach ($provinces as $item)
                                    <option value="{{ $item->kd_provinsi }}"
                                        @if ($item->kd_provinsi == $region->kd_provinsi) selected @endif>{{ $item->nm_provinsi }}</option>
                                @endforeach
                            </select></div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><select name="kd_kota" id="kota" class="form-control"
                                ...
                                @if ($region->kd_kota)
                                    <option value="{{ $region->kota->kd_kota }}">{{ $region->kota->nm_kota }}</option>
                                @endif
                            </select></div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><input type="text" name="latitude" id="latitude"
                                class="form-control" value="{{ $region->latitude }}" required></div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><input type="text" name="fax" id="fax"
                                class="form-control" value="{{ $region->fax }}">
                        </div>
                    </div>
