                                    ...
                                    @foreach ($menu as $mn)
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><input type="checkbox"
                                                    onclick="checkAll(this, {{ $mn['id_menu'] }})"
                                                    id="can_all-{{ $mn['id_menu'] }}" value="Y" <?php echo $mn['can_all'] == 'Y' ? 'checked' : ''; ?>>
                                            </td>
                                            <td align="center"><input type="checkbox" onclick="checkedItem(this)"
                                                    id="can_access-{{ $mn['id_menu'] }}"
                                                    name="can_access[{{ $mn['id_menu'] }}]" value="Y"
                                                    <?php echo $mn['can_access'] == 'Y' ? 'checked' : ''; ?>></td>
                                            <td align="center"><input type="checkbox" onclick="checkedItem(this)"
                                                    id="can_create-{{ $mn['id_menu'] }}"
                                                    name="can_create[{{ $mn['id_menu'] }}]" value="Y"
                                                    <?php echo $mn['can_create'] == 'Y' ? 'checked' : ''; ?>></td>
                                            <td align="center"><input type="checkbox" onclick="checkedItem(this)"
                                                    id="can_update-{{ $mn['id_menu'] }}"
                                                    name="can_update[{{ $mn['id_menu'] }}]" value="Y"
                                                    <?php echo $mn['can_update'] == 'Y' ? 'checked' : ''; ?>></td>
                                            <td align="center"><input type="checkbox" onclick="checkedItem(this)"
                                                    id="can_delete-{{ $mn['id_menu'] }}"
                                                    name="can_delete[{{ $mn['id_menu'] }}]" value="Y"
                                                    <?php echo $mn['can_delete'] == 'Y' ? 'checked' : ''; ?>></td>
