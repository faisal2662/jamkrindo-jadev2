                    ...
                    <div class="card chat-app">
                        ...
                        <div class="chat" style="margin-left: 0;">
                            ...
                            <div class="chat-message clearfix">
                                <div class="attachment-preview-container mb-1"></div>
                                <div class="input-group mb-0">

                                    <div class="btn-group dropup">
                                        <span class="btn " data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="bi bi-paperclip  fw-3 fs-5"></i>
                                        </span>
        ...
        $('#document').on('change', function() {
            ...
            if (files.length > 0) {
                $.each(files, function(index, file) {
                    ...
                    let previewElement;
                    previewElement = `
                        <div class="attachment-preview" style="border-radius:10px;  background-color: white;margin-top: 5px;padding: 5px;">
    ...
    <script>
        ...
        function connectWebSocket(chatId) {
            return new Promise((resolve, reject) => {
                ...
                const wsUrl =
                    `${baseWsUrl}id_cabang=${cabangId}&id_user=${chatId}&conversation_id=${conversationId}`;
...
`);
                ...
                const chatContainer = $('#box-message');
                console.log('scrol')
                chatContainer.scrollTop(chatContainer[0].scrollHeight);
            });
        }
