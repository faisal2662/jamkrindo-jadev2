...
@section('script')
    ...
    <script>
        ...
        const baseWsUrl = 'ws://localhost:8080?type=admin&';
...
`);
        ...
        $('#close-chatting').click(function() {
            ...
            formData.append('conversationId', $(this).data('conversation'));
            $.ajax({
                ...
                success: function(res) {
                    ...
                    let message =
                        "Terimakasih telah mengubungi Jamkrindo. /n Silahkan hubungi kembali jika ada pertanyaan yang ingin ditanyakan"
                    ...
                    $(`.list-message[data-id=${currentConversationId}] span.adminReceive`).text('')
                    $(`.list-message[data-id=${currentConversationId}] span.adminReceive`).data('id',
                        '')
                },
                complete: function() {
