                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body justify-content-center">
                                    ...
                                    @endif
                                    <form class="row g-3 needs-validation" method="POST" action="{{ route('forgot.password.send') }}" novalidate id="login-admin">
                                        @csrf
                                        <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <p class="small mb-0 text-center"><a href="{{ route('login') }}" class="text-black">Remember password?</a></p>
                                    </div>
