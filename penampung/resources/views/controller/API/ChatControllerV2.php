...
class ChatControllerV2 extends Controller
{
    public function getChats()
    {
        ...
        if ($employee->position->sebagai_posisi == 'Kepala Unit Kerja') {
            $contacts
        ...
        } else if ($employee->position->sebagai_posisi == 'Kepala Bagian Unit Kerja') {
            $contacts
                ->whereHas('employee', function ($query) use ($employee) {
                    $query->where([
                        'id_bagian_kantor_pusat' => $employee->id_bagian_kantor_pusat,
                        ...
                        ->where(function ($subQuery) use ($complaint) {
                            $subQuery
                                ...
                                ->whereHas('position', function ($query) {
                                    $query->whereIn('sebagai_posisi', ['Kepala Unit Kerja', 'Kepala Bagian Unit Kerja', 'Staf']);
                                });
                        })
