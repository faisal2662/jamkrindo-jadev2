                ...
                <form method="post" id="categoryProductForm" enctype="multipart/form-data">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="nm_category"  id="nm_category" class="form-control" required>
                            </td>
                        </tr>
                        <tr>
...
<script>
    ...
    function categoryProductEdit(id) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                // if (res.description_produk) {
                //     tinymce.get('description').setContent(res.description_produk);
                // } else {
    ...
    $('#categoryProductForm').on('submit', function(e) {
        ...
        formData.append('nm_category', $('#nm_category').val());
