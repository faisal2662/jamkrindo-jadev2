            ...
            <div class="tab-pane fade show active profile-overview">
                ...
                <div class="row mb-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col"><span class="label">Updated By : </span> {{ $category->updated_date ? Carbon\Carbon::parse($category->updated_date)->translatedFormat('l, d F Y') : '-' }} </div>
                        <div class="col"><span class="label">Deleted By : </span> {{  $category->deleted_date ? Carbon\Carbon::parse($category->updated_date)->translatedFormat('l, d F Y') : '-'}} </div>
