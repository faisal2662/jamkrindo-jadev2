...
@section('main')
    ...
    <div class="modal fade" id="hapus" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Apakah Kamu yakin ingin mengajukan hapus ?</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Userid : <strong><span id="delete_nama_customer"></span></strong></p>
                </div>
...
@section('script')
    <script>
        ...
        function customerDelete(id, name) {
            $('#hapus').modal('show');
            $('#delete_nama_customer').text(name);
