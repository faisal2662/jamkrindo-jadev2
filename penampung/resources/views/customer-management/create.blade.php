...
@section('main')
    <div class="pagetitle">
        <h1>Tambah Customer Management</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard">Dashboard</a></li>
                <li class="breadcrumb-item active">Tambah Customer Management</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    <div class="mb-2">
    ...
    <section class="profile">
        <div class="row bg-white p-4">
            ...
            <div class="tab-pane fade show active profile-overview">
                ...
                <form method="POST" action="{{ route('customer-manager.save') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Nama Customer <span class="text-danger me-3">*</span></div>
                        <div class="col-lg-9 col-md-8"><input type="text" value="{{ old('nama_customer') }}"
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><input type="number" value="{{ old('hp_customer') }}"
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><input type="text" value="{{ old('userid_customer') }}"
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><input type="email" value="{{ old('email_customer') }}"
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><input type="text" class="form-control"
                                name="kd_referral_customer" placeholder="Opsional" id="kd_referral_customer"></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Status Customer <span class="text-danger me-3">*</span></div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><select required name="wilayah" id="wilayah" class="form-control">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><select name="cabang" id="cabang" required
                                class="form-control">
                                <option value="" disabled selected></option>
                            </select></div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Password <span class="text-danger me-3">*</span></div>
                        <div class="col-lg-9 col-md-8">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Konfirmasi Password<span class="text-danger me-3">*</span>
                        </div>
                        <div class="col-lg-9 col-md-8">
                            <div class="input-group has-validation">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-9 col-md-8"><input type="text" value="{{ old('company_name') }}"
                    ...
                    <!--    <div class="col-lg-9 col-md-8"><input value="{{ old('terms') }}" type="text"-->
                    <!--            class="form-control" name="terms" id="terms">-->
                    <!--    </div>-->
                    <!--</div>-->
