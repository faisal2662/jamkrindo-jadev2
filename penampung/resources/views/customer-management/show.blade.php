    ...
    @section('main')
        ...
        <div class="mb-2">
            <a href="{{ route('customer-manager.index') }}" class="btn btn-secondary btn-sm"><i
                    class="bi bi-arrow-left-short"></i> Kembali</a>
        </div>
        <section class="profile">
            <div class="row bg-white p-4">
                <div class="alert alert-danger alert-dismissible fade text-center show" style="display: none;" id="notification" role="alert">
                ...
                <div class="tab-pane fade show active profile-overview">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Provinsi</div>
                            ...
                            <div class="col-lg-9 col-md-8">{{ $customer->nm_provinsi }}</div>
                        
                    </div>
                    <div class="row mb-2">
                        <div class="col-lg-3 col-md-4 label">Kota</div>
                    
                            <div class="col-lg-9 col-md-8">{{ $customer->nm_kota }}</div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    {{-- <div class="modal-body" id="dis-delete">
                        <h6> jika kamu menghapus data ini, data tidak bisa dikembalikan lagi</h6>
                    </div> --}}
