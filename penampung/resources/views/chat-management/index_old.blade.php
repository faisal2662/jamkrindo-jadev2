                                    ...
                                    <div class="btn-group dropup ">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><span class="ms-3"><label for="document"><i
                                                        ...
                                                        Dokumen</label><input type="file" name="document"
                                            ...
                                            <li><span class="ms-3"><label for="video"> <i
                                                        ...
                                                        Video</label><input type="file" name="video" id="video"
                                                        accept=".mp4" style="display: none"></span></li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <button onclick="close()" onclick="" id="close" style="border:none;"
...
@section('script')
    ...
    <script>
        ...
        let socket = null;
        var baseWsUrl = 'ws://10.220.60.63:8090?type=admin&';
                        ...
                        $('#conversationList').append(
                            ...
                            <img src="{{ asset('assets/img/customer/${conversation.customer.foto_customer}') }}" alt="avatar">
                                    <div class="about">
                                        ...
                                        <div class="status"> <i class="fa fa-circle offline"></i> ${waktu(conversation.created_date)}</div>
                                    </div>
                                </li>`
                        );
                    } else {
                ...
                socket.onmessage = function(event) {
                    ...
                    $('#notif').append(` <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                         ...
                         <strong class="me-auto">${data.send_id}</strong>
                            <small class="text-body-secondary" id="timeElapsed" data-timestamp="${lastMessageTime}">, <span class="time-elapsed"></span> </small>
