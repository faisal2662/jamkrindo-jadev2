          ...
          @if (Auth::guard('web')->user())
            ...
            //   var_dump($role);
              ...
              @foreach ($role as $rl)
                  ...
                  @if ($rl->id_menu == 21)
                      @if ($rl->can_access == 'Y')
                          <li class="nav-item  @if (request()->route()->uri == 'report' || request()->route()->uri == 'report/dwh') active @endif">
                              <a class="nav-link @if (request()->route()->uri == 'report' || request()->route()->uri == 'report/dwh') '' @else collapsed @endif"
                                  href="{{ route('report.dwh') }}">
                                  <i class="bi bi-file-earmark-person"></i>

                                  <span>Laporan DWH SPD</span>
                              </a>
                          </li>
                      @endif
                  @endif
              ...
              {{-- <li class="nav-item">
                  @foreach ($role as $rl)
                      @if ($rl->id_menu == 21)
                          @if ($rl->can_access == 'Y')
                              <a class="nav-link  @if (request()->route()->uri == 'report' || request()->route()->uri == 'report/dwh') active @else collapsed @endif"
                      ...
                      @endif
                  @endforeach
                  <ul id="laporan-dwh" class="nav-content collapse @if (request()->route()->uri == 'report/dwh') show @endif"
                      data-bs-parent="#sidebar-nav">
                      @foreach ($role as $rl)
                          @if ($rl->id_menu == 22)
                              @if ($rl->can_access == 'Y')
                                  <li>
                                      <a href="{{ route('report/dwh') }}"
                                          class="@if (request()->route()->uri == 'branchs-management' || request()->route()->uri == 'branchs-management/lihat/{id}') active @endif">
                                          <i class="bi bi-circle"></i><span>Laporan SPD</span>
                                      </a>
                                  </li>
                              @endif
                          @endif
